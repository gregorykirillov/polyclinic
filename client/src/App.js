...
import {Home, About, Doctors, Contacts, Ambulance, CallDoctor, Reception, NotFound} from './pages';
import {AdminSpecialties, AdminDoctors, AdminPatients,
    AdminDiagnoses, AdminResults, AdminSchedule} from './pages/Admin/pages';
